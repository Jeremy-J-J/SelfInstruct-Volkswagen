...
SYSTEM_PROMPT_2 = """
You are an expert in prompt conversion. Given an input prompt that generates OpenSCENARIO v1.0 XML content, please convert it into a prompt that generates OpenSCENARIO v2.0 DSL content.
Retrun the converted prompt *ONLY*
"""
        ...
        try:
            for p in prompts:
                resp = client.chat.completions.create(
                    model="holo-model",
                    messages=[{"role": "system", "content": SYSTEM_PROMPT_2}, {"role": "user", "content": p}],
