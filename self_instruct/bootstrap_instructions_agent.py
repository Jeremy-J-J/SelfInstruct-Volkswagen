...
from gpt3_api_instructions_agent import make_requests as make_gpt3_requests
...
def post_process_gpt3_response(response):
    ...
    for inst in raw_instructions:
        ...
        #     continue
        if any(find_word_in_string(word, inst) for word in ["image", "images", "graph", "graphs", "picture", "pictures", "map", "maps", "draw", "plot", "go to"]):
            continue
...
if __name__ == "__main__":
    ...
    seed_instructions = [t["instruction"]  +
         (" " + t["instances"][0]["input"] if t["instances"][0]["input"] else "") 
         for t in seed_tasks]
